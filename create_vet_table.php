          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_vet.html" class="btn btn-primary" name="save" value="create">
                  Create Vet Form
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Vet Records</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
...
$vets = $conn->query("SELECT * FROM vets");
?>
        ...
        <?php while ($row = $vets->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    ...
                    <form action="delete_vet.php" method="POST" style="display:inline;">
...
<div class="modal" id="editModal">
    <form action="update_vet.php" method="POST">
...
$(document).ready(function () {
    ...
    $('.editBtn').click(function () {
        ...
        $('#edit_specialization').val(row.specialization);
