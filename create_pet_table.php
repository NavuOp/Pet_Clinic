          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_pet.html" class="btn btn-primary" name="save" value="create">
                  Create Pet Form
        ...
        <?php while ($row = $pets->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    ...
                    <form action="delete_pet.php" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this pet?');">
...
<div class="modal" id="editModal">
    <form action="insert_pet.php" method="POST">
        ...
        <input type="number" name="owner_id" id="edit_owner_id" required>
...
$(document).ready(function () {
    ...
    $('.editBtn').click(function () {
        ...
        $('#edit_id').val(row.id);
        $('#edit_pet_name').val(row.pet_name);
        $('#edit_species').val(row.species);
        $('#edit_breed').val(row.breed);
        $('#edit_age').val(row.age);
        $('#edit_gender').val(row.gender);
        $('#edit_owner_id').val(row.owner_id);
