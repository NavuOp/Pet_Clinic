          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_Appointment.html" class="btn btn-primary" name="save" value="create">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Appointment Records</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
    ...
    <tbody>
        <?php while ($row = $appointments->fetch_assoc()): ?>
            <tr data-id="<?= $row['id'] ?>">
                ...
                <td><?= $row['reason'] ?></td>
                <td>
                    <button class="editBtn" data-row='<?= json_encode($row) ?>'>Edit</button>
...
<div class="modal" id="editModal">
    <form action="update_appointment.php" method="POST">
        ...
        <label>Pet ID</label>
        <input type="text" name="pet_id" id="edit_pet_id" required>

        <label>Vet ID</label>
        <input type="text" name="vet_id" id="edit_vet_id" required>

        <label>Contact Phone</label>
        <input type="text" name="contact_phone" id="edit_phone" required>

        <label>Appointment Date</label>
        <input type="date" name="appointment_date" id="edit_date" required>

        <label>Time Slot</label>
        <input type="text" name="time_slot" id="edit_slot" required>
...
$(document).ready(function () {
    ...
    $('.editBtn').click(function () {
        ...
        $('#edit_id').val(row.id);
        $('#edit_pet_id').val(row.pet_id);
        $('#edit_vet_id').val(row.vet_id);
        $('#edit_phone').val(row.phone);
        $('#edit_date').val(row.appointment_date);
        $('#edit_slot').val(row.time_slot);
        $('#edit_reason').val(row.reason);
        $('.overlay, #editModal').fadeIn();
    });
