          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_owner.html" class="btn btn-primary" name="save" value="create">
                  Create Owner Form
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Owner Records</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
...
<table id="ownerTable" class="display">
    <thead>
        <tr>
            <th>ID</th>
            <th>Full Name</th>
        ...
        <tr>
            ...
            <td>
                <button class="editBtn"
                        data-row='<?= json_encode($row, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_QUOT) ?>'>
                  Edit
                </button>
                <a href="delete_owner.php?id=<?= $row['id'] ?>"
                   class="deleteBtn"
...
<div class="modal" id="editModal">
  <form action="insert_owners.php" method="POST">
    ...
    <input type="text" name="ownername" id="edit_fullname" required>
