          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_Treatment.html" class="btn btn-primary" name="save" value="create">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Treatment Records</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
    ...
    <tbody>
        <?php while ($row = $treatments->fetch_assoc()): ?>
            <tr>
                ...
                <td><?= $row['medicines_given'] ?></td>
                <td><?= $row['cost'] ?></td>
                <td><button class="editBtn" data-row='<?= json_encode($row) ?>'>Edit</button>
...
<div class="modal" id="editModal">
  ...
  <input type="number" name="petid" placeholder="Pet ID" required>
  <input type="number" name="vetid" placeholder="Vet ID" required>
...
$(document).ready(function () {
    ...
    $('.editBtn').click(function () {
        ...
        $('#edit_id').val(row.id);
        $('#edit_appointment_id').val(row.appointment_id);
        $('#edit_treatment_description').val(row.treatment_description);
        $('#edit_medicines_given').val(row.medicines_given);
